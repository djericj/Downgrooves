...
export class AudioService {
  ...
  public currentTrack: BehaviorSubject<ITunesTrack> = new BehaviorSubject(null);
  ...
  //     this.playAudio();
  // }
  public setAudio(track: ITunesTrack): void {
  ...
  /**
   * If you need the current track instance in your component, use this.
   */
  // public getCurrentTrack(): ITunesTrack {
